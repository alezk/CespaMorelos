 ...
 * @author Alejandro
 */
public class ServletArchivoJsonSolicitudesPorSemana extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           GestorSolicitudesDeExamen g = new GestorSolicitudesDeExamen();
            ...
            ruta = request.getServletContext().getRealPath("/Json/JsonSolicitudesPorSemana.json");

            FileWriter fichero = new FileWriter(ruta);
            PrintWriter pw = new PrintWriter(fichero);

            pw.write(respuestaJSON(g.ListaTotalSolicitudesExamen()));
            pw.flush();
            fichero.flush();
            pw.close();
            fichero.close();
