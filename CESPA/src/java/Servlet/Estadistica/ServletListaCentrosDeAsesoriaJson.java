 ...
 * @author Alejandro
 */
public class ServletListaCentrosDeAsesoriaJson extends HttpServlet {
  ...
  try (PrintWriter out = response.getWriter()) {
            DaoCentrosDeAsesoriaDetalle g = new DaoCentrosDeAsesoriaDetalle();
            String mensajeJson;
          
            mensajeJson = respuestaJSON(g.CentroDeAsesoria(request.getParameter("tipo")));
