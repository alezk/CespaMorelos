...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<%=contex%>/Css/cespastyletablacentrosAzul.css" />
        <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
        <script src="<%=contex%>/Js/Ajax/AjaxAprobechamientoAcademico.js"></script>
        <title>Centro de Asesoria Social</title>
    </head>
    <body onload="CentrosSociales('Ordinarios', '<%=contex%>')">

        <div id="Regresar">
            <a title="Actualizar Grafica" href="#">
                <img id="recargaPagina" onclick="ArchivoJson('Ordinarios', '<%=contex%>')" style="max-width: 50px; max-height: 50px;" src="<%=contex%>/Img/actualizarDos.png"/>
            </a>
        </div>
        ...
        <div id="divTablaJson">
            <div id="labelTable">Aprovechamiento Ordinarios</div>
            <table id="tablaJson">
                <tr>
