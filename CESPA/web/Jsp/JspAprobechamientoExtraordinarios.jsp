<%-- 
    Document   : JapAprobechamientoAcademico
    Created on : 21/08/2015, 09:53:18 AM
    Author     : Alejandro
--%>
...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<%=contex%>/Css/cespastyletablacentrosVioleta.css" />
        <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
        <script src="<%=contex%>/Js/Ajax/AjaxAprobechamientoAcademicoExt.js"></script>
        <title>Centro de Asesoria Social</title>
    </head>
    <body onload="CentrosSociales('Extraordinarios', '<%=contex%>')">

        <div id="Regresar">
            <a title="Actualizar Grafica" href="#">
                <img id="recargaPagina" onclick="ArchivoJson('Extraordinarios', '<%=contex%>')" style="max-width: 50px; max-height: 50px;" src="<%=contex%>/Img/actualizarDos.png"/>
            </a>
        </div>

        <div id="Menu">
            <a title="Menú" href="<%=contex%>/Jsp/JspMenuPlaneacion.jsp">
        ...
        <div id="divTablaJson">
            <div id="labelTable">Aprovechamiento Extraordinarios</div>
            <table id="tablaJson">
                <tr>
