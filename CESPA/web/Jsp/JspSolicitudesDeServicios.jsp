...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<%=contex%>/Css/cespastyletablaservicios.css" />
        <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
        <script src="<%=contex%>/Js/Ajax/AjaxSolicitudesDeServicio.js"></script>
    ...
    <body onload="solicitudesSemanales('<%=contex%>')">
        ...
        <script src="<%=contex%>/Js/themes/grid-servicios.js"></script>
