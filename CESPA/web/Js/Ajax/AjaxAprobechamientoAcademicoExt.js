...
$(function() {
    ...
    CentrosSociales = function(tipo, contex) {
        ...
        if (tipo === 'Ordinarios') {
            url = contex + "/Json/JsonAprobechamientoOrdinarios.json";
        } else {
            url = contex + "/Json/JsonAprobechamientoExtraordinarios.json";
        }
...
//        alert('Error en la carga'+a.status+" "+e);
    ...
    tablaSemanalJson = function(json) {
        ...
        $('#idTablaJSON').append(es22 + "<td>" + 0 + "</td>");
        $('#idTablaJSON').append(genH22 + "<td id='h22T'>" + 0 + "</td>");
        $('#idTablaJSON').append(genM22 + "<td id='m22T'>" + 0 + "</td>");
        $('#idTablaJSON').append(sol22 + "<td>" + 0 + "</td>");
        $('#idTablaJSON').append(pre22 + "<td>" + 0 + "</td>");
        $('#idTablaJSON').append(ac22 + "<td>" + 0+ "</td>");
        ...
        $('#idTablaJSON').append(es33 + "<td>" + json.Totales[0] + "</td>");
        $('#idTablaJSON').append(genH33 + "<td id='h33T'>" + 0 + "</td>");
        $('#idTablaJSON').append(genM33 + "<td id='m33T'>" + 0 + "</td>");
        $('#idTablaJSON').append(sol33 + "<td>" + json.Totales[1] + "</td>");
        $('#idTablaJSON').append(pre33 + "<td>" + json.Totales[2] + "</td>");
        $('#idTablaJSON').append(ac33 + "<td>" + json.Totales[3] + "</td>");
...
//------------------AjaxParaCrearArchivosJson------------------//
    ...
    ArchivoJson = function(tipo, contex) {
        ...
        url = contex + "/ServletArchivoJsonAprobechamientoAcademico";
        $.ajax(
                {
                    type: "GET",
                    url: url,
